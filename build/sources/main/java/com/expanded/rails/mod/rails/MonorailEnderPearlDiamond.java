...
public class MonorailEnderPearlDiamond extends BlockRail
{

	public MonorailEnderPearlDiamond(int par1)
    {
        super();
        setHardness(0.7F);
        setSoundType(SoundType.METAL);
        setUnlocalizedName("expandedrails:EnderPearlDiamondMonorail");
