...
public class TriplerailEnderPearlDiamond extends BlockRail
{

	public TriplerailEnderPearlDiamond(int par1)
    {
        super();
        setHardness(0.7F);
        setSoundType(SoundType.METAL);
        setUnlocalizedName("expandedrails:EnderPearlDiamondTriplerail");
