...
if(ID == NileTable) {
TileEntity target = world.func_175625_s(new BlockPos(x, y, z));
if(!(target instanceof TileEntityNileWorkbench))
return null;
TileEntityNileWorkbench tileNileTable = (TileEntityNileWorkbench)target;
ContainerNileWorkbench tableContainer = new ContainerNileWorkbench(tileNileTable, player.field_71071_by, world, new BlockPos(x, y, z));
...
return null;
TileEntityNileWorkbench tileNileTable = (TileEntityNileWorkbench)target;
GuiNileWorkbench tableGui = new GuiNileWorkbench(player.field_71071_by, tileNileTable, world, new BlockPos(x, y, z));
return tableGui;
}
return null;
}
