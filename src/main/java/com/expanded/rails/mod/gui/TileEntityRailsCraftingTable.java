...
public class TileEntityRailsCraftingTable extends TileEntity implements IInventory
{
private ItemStack[] inventory;
public IInventory craftResult = new InventoryCraftResult();
public ItemStack[] craftMatrixInventory;
public TileEntityRailsCraftingTable() {
super();
...
return par1Entityplayer.getDistanceSq(this.pos.getX() + 0.5, this.pos.getY() + 0.5, this.pos.getZ() + 0.5) <= 64;
}
@Override
