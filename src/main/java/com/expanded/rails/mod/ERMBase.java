...
//railBrake = new TileEntityRailBrake(railBrakeID, Material.rock).setUnlocalizedName("railBrake");
        ...
        //Tabs
        LanguageRegistry.instance().addStringLocalization("tabNormalRails", "en_US", "Normal Rails");
        ...
        LanguageRegistry.instance().addStringLocalization("tabMonoRails", "en_US", "Mono Rails");
        ...
        LanguageRegistry.instance().addStringLocalization("tabTripleRails", "en_US", "Triple Rails");
...
//GameRegistry.registerTileEntity(TileEntityRailBrakeEntity.class, "railBrake");
        ...
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(diamondRail), 0,new ModelResourceLocation(modid+":"+"diamondRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(lapisRail), 0,new ModelResourceLocation(modid+":"+"lapisRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(iceRail), 0,new ModelResourceLocation(modid+":"+"iceRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(glowstoneRail), 0,new ModelResourceLocation(modid+":"+"glowstoneRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(diamondNetherRail), 0,new ModelResourceLocation(modid+":"+"diamondNetherRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(diamondObsidianRail), 0,new ModelResourceLocation(modid+":"+"diamondObsidianRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(brickRail), 0,new ModelResourceLocation(modid+":"+"brickRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(emeraldRail), 0,new ModelResourceLocation(modid+":"+"emeraldRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(netherStarRail), 0,new ModelResourceLocation(modid+":"+"netherStarRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(enderPearlRail), 0,new ModelResourceLocation(modid+":"+"enderPearlRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(chainRail), 0,new ModelResourceLocation(modid+":"+"chainRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(armedRail), 0,new ModelResourceLocation(modid+":"+"armedRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(railsCraftingTable), 0,new ModelResourceLocation(modid+":"+"railsCraftingTable", "inventory"));
        //Monorail//
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailDiamond), 0,new ModelResourceLocation(modid+":"+"monorailDiamond", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailGlowing), 0,new ModelResourceLocation(modid+":"+"monorailGlowing", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailGrayOrange), 0,new ModelResourceLocation(modid+":"+"monorailGrayOrange", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailNether), 0,new ModelResourceLocation(modid+":"+"monorailNether", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailObsidian), 0,new ModelResourceLocation(modid+":"+"monorailObsidian", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailRedGreen), 0,new ModelResourceLocation(modid+":"+"monorailRedGreen", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailYellowBlue), 0,new ModelResourceLocation(modid+":"+"monorailYellowBlue", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailEmerald), 0,new ModelResourceLocation(modid+":"+"monorailEmerald", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailLapis), 0,new ModelResourceLocation(modid+":"+"monorailLapis", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailGold), 0,new ModelResourceLocation(modid+":"+"monorailGold", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailPowered), 0,new ModelResourceLocation(modid+":"+"monorailPowered", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailIce), 0,new ModelResourceLocation(modid+":"+"monorailIce", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailChain), 0,new ModelResourceLocation(modid+":"+"monorailChain", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailArmed), 0,new ModelResourceLocation(modid+":"+"monorailArmed", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailEnderPearl), 0,new ModelResourceLocation(modid+":"+"monorailEnderPearl", "inventory"));
        //Triplerail//
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailDiamond), 0,new ModelResourceLocation(modid+":"+"triplerailDiamond", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailGlowing), 0,new ModelResourceLocation(modid+":"+"triplerailGlowing", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailNether), 0,new ModelResourceLocation(modid+":"+"triplerailNether", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailObsidian), 0,new ModelResourceLocation(modid+":"+"triplerailObsidian", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailEmerald), 0,new ModelResourceLocation(modid+":"+"triplerailEmerald", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailLapis), 0,new ModelResourceLocation(modid+":"+"triplerailLapis", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailPowered), 0,new ModelResourceLocation(modid+":"+"triplerailPowered", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailIce), 0,new ModelResourceLocation(modid+":"+"triplerailIce", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailChain), 0,new ModelResourceLocation(modid+":"+"triplerailChain", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailArmed), 0,new ModelResourceLocation(modid+":"+"triplerailArmed", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailEnderPearl), 0,new ModelResourceLocation(modid+":"+"triplerailEnderPearl", "inventory"));
        //Wool Rails//
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(whiteWoolRail), 0,new ModelResourceLocation(modid+":"+"whiteWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(orangeWoolRail), 0,new ModelResourceLocation(modid+":"+"orangeWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(magentaWoolRail), 0,new ModelResourceLocation(modid+":"+"magentaWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(lightblueWoolRail), 0,new ModelResourceLocation(modid+":"+"lightblueWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(yellowWoolRail), 0,new ModelResourceLocation(modid+":"+"yellowWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(limeWoolRail), 0,new ModelResourceLocation(modid+":"+"limeWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(pinkWoolRail), 0,new ModelResourceLocation(modid+":"+"pinkWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(grayWoolRail), 0,new ModelResourceLocation(modid+":"+"grayWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(lightgrayWoolRail), 0,new ModelResourceLocation(modid+":"+"lightgrayWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(cyanWoolRail), 0,new ModelResourceLocation(modid+":"+"cyanWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(purpleWoolRail), 0,new ModelResourceLocation(modid+":"+"purpleWoolRail", "inventory"));
        ...
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(brownWoolRail), 0,new ModelResourceLocation(modid+":"+"brownWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(greenWoolRail), 0,new ModelResourceLocation(modid+":"+"greenWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(redWoolRail), 0,new ModelResourceLocation(modid+":"+"redWoolRail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(blackWoolRail), 0,new ModelResourceLocation(modid+":"+"blackWoolRail", "inventory"));
        //Wool Monorails//
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailWhite), 0,new ModelResourceLocation(modid+":"+"monorailWhite", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailOrange), 0,new ModelResourceLocation(modid+":"+"monorailOrange", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailMagenta), 0,new ModelResourceLocation(modid+":"+"monorailMagenta", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailLightblue), 0,new ModelResourceLocation(modid+":"+"monorailLightblue", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailYellow), 0,new ModelResourceLocation(modid+":"+"monorailYellow", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailLime), 0,new ModelResourceLocation(modid+":"+"monorailLime", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailPink), 0,new ModelResourceLocation(modid+":"+"monorailPink", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailGray), 0,new ModelResourceLocation(modid+":"+"monorailGray", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailLightgray), 0,new ModelResourceLocation(modid+":"+"monorailLightgray", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailCyan), 0,new ModelResourceLocation(modid+":"+"monorailCyan", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailPurple), 0,new ModelResourceLocation(modid+":"+"monorailPurple", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailBlue), 0,new ModelResourceLocation(modid+":"+"monorailBlue", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailBrown), 0,new ModelResourceLocation(modid+":"+"monorailBrown", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailGreen), 0,new ModelResourceLocation(modid+":"+"monorailGreen", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailRed), 0,new ModelResourceLocation(modid+":"+"monorailRed", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(monorailBlack), 0,new ModelResourceLocation(modid+":"+"monorailBlack", "inventory"));
        //wool Triplerails//
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailWhite), 0,new ModelResourceLocation(modid+":"+"triplerailWhite", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailOrange), 0,new ModelResourceLocation(modid+":"+"triplerailOrange", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailMagenta), 0,new ModelResourceLocation(modid+":"+"triplerailMagenta", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailLightblue), 0,new ModelResourceLocation(modid+":"+"triplerailLightblue", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailYellow), 0,new ModelResourceLocation(modid+":"+"triplerailYellow", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailLime), 0,new ModelResourceLocation(modid+":"+"triplerailLime", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailPink), 0,new ModelResourceLocation(modid+":"+"triplerailPink", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailGray), 0,new ModelResourceLocation(modid+":"+"triplerailGray", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailLightgray), 0,new ModelResourceLocation(modid+":"+"triplerailLightgray", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailCyan), 0,new ModelResourceLocation(modid+":"+"triplerailCyan", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailPurple), 0,new ModelResourceLocation(modid+":"+"triplerailPurple", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailBlue), 0,new ModelResourceLocation(modid+":"+"triplerailBlue", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailBrown), 0,new ModelResourceLocation(modid+":"+"triplerailBrown", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailGreen), 0,new ModelResourceLocation(modid+":"+"triplerailGreen", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailRed), 0,new ModelResourceLocation(modid+":"+"triplerailRed", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(net.minecraft.item.Item.getItemFromBlock(triplerailBlack), 0,new ModelResourceLocation(modid+":"+"triplerailBlack", "inventory"));
        //Custom Items//
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((emeraldBar), 0,new ModelResourceLocation(modid+":"+"emeraldBar", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((diamondBar), 0,new ModelResourceLocation(modid+":"+"diamondBar", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((obsidianBar), 0,new ModelResourceLocation(modid+":"+"obsidianBar", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((lapisBar), 0,new ModelResourceLocation(modid+":"+"lapisBar", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((explosiveBar), 0,new ModelResourceLocation(modid+":"+"explosiveBar", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((ironNail), 0,new ModelResourceLocation(modid+":"+"ironNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((goldNail), 0,new ModelResourceLocation(modid+":"+"goldNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((diamondNail), 0,new ModelResourceLocation(modid+":"+"diamondNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((emeraldNail), 0,new ModelResourceLocation(modid+":"+"emeraldNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((obsidianNail), 0,new ModelResourceLocation(modid+":"+"obsidianNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((netherrackNail), 0,new ModelResourceLocation(modid+":"+"netherrackNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((woolenNail), 0,new ModelResourceLocation(modid+":"+"woolenNail", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((netherIngot), 0,new ModelResourceLocation(modid+":"+"netherIngot", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railIronBase), 0,new ModelResourceLocation(modid+":"+"railIronBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railDiamondBase), 0,new ModelResourceLocation(modid+":"+"railDiamondBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railObsidianBase), 0,new ModelResourceLocation(modid+":"+"railObsidianBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railNetherrackBase), 0,new ModelResourceLocation(modid+":"+"railNetherrackBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railEmeraldBase), 0,new ModelResourceLocation(modid+":"+"railEmeraldBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railLapisBase), 0,new ModelResourceLocation(modid+":"+"railLapisBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railGoldBase), 0,new ModelResourceLocation(modid+":"+"railGoldBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railArmedBase), 0,new ModelResourceLocation(modid+":"+"railArmedBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railChainBase), 0,new ModelResourceLocation(modid+":"+"railChainBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railIceBase), 0,new ModelResourceLocation(modid+":"+"railIceBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((railEnderPearlBase), 0,new ModelResourceLocation(modid+":"+"railEnderPearlBase", "inventory"));
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register((obsidianChunk), 0,new ModelResourceLocation(modid+":"+"obsidianChunk", "inventory"));
    }
