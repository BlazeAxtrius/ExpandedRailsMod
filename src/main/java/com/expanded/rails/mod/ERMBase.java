...
//    	railBrakeID = config.get("block", "TileEntityRailBrake",3055).getInt();
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        brickRail = new BrickRail(brickRailID).setBlockName("brickRail");
        emeraldRail = new EmeraldRail(emeraldRailID).setBlockName("emeraldRail");
        netherStarRail = new NetherStarRail(netherStarRailID).setBlockName("netherStarRail");
        ...
        monorailGrayOrange = new MonorailGrayOrange(monorailGrayOrangeID).setBlockName("monorailGrayOrange");
        monorailNether = new MonorailNether(monorailNetherID).setBlockName("monorailNether");
        monorailObsidian = new MonorailObsidian(monorailObsidianID).setBlockName("monorailObsidian");
        monorailRedGreen = new MonorailRedGreen(monorailRedGreenID).setBlockName("monorailRedGreen");
        monorailYellowBlue = new MonorailYellowBlue(monorailYellowBlueID).setBlockName("monorailYellowBlue");
        ...
        monorailGold = new MonorailGold(monorailGoldID).setBlockName("monorailGold");
        ...
        //Triplerail//
        triplerailDiamond = new TriplerailDiamond(triplerailDiamondID).setBlockName("triplerailDiamond");
        triplerailGlowing = new TriplerailGlowing(triplerailGlowingID).setBlockName("triplerailGlowing");
        triplerailNether = new TriplerailNether(triplerailNetherID).setBlockName("triplerailNether");
        triplerailObsidian = new TriplerailObsidian(triplerailObsidianID).setBlockName("triplerailObsidian");
        triplerailEmerald = new TriplerailEmerald(triplerailEmeraldID).setBlockName("triplerailEmerald");
        triplerailLapis = new TriplerailLapis(triplerailLapisID).setBlockName("triplerailLapis");
        triplerailPowered = new TriplerailPowered(triplerailPoweredID).setBlockName("triplerailPowered");
        triplerailIce = new TriplerailIce(triplerailIceID).setBlockName("triplerailIce");
        triplerailChain = new TriplerailChain(triplerailChainID).setBlockName("triplerailChain");
        triplerailArmed = new TriplerailArmed(triplerailArmedID).setBlockName("triplerailArmed");
        triplerailEnderPearl = new TriplerailEnderPearl(triplerailEnderPearlID).setBlockName("triplerailEnderPearl");
        //Wool Rails//
        whiteWoolRail = new WhiteWoolRail(whiteWoolRailID).setBlockName("whiteWoolRail");
        orangeWoolRail = new OrangeWoolRail(orangeWoolRailID).setBlockName("orangeWoolRail");
        magentaWoolRail = new MagentaWoolRail(magentaWoolRailID).setBlockName("magentaWoolRail");
        lightblueWoolRail = new LightBlueWoolRail(lightblueWoolRailID).setBlockName("lightblueWoolRail");
        yellowWoolRail = new YellowWoolRail(yellowWoolRailID).setBlockName("yellowWoolRail");
        limeWoolRail = new LimeWoolRail(limeWoolRailID).setBlockName("limeWoolRail");
        pinkWoolRail = new PinkWoolRail(pinkWoolRailID).setBlockName("pinkWoolRail");
        grayWoolRail = new GrayWoolRail(grayWoolRailID).setBlockName("grayWoolRail");
        lightgrayWoolRail = new LightGrayWoolRail(lightgrayWoolRailID).setBlockName("lightgrayWoolRail");
        cyanWoolRail = new CyanWoolRail(cyanWoolRailID).setBlockName("cyanWoolRail");
        purpleWoolRail = new PurpleWoolRail(purpleWoolRailID).setBlockName("purpleWoolRail");
        blueWoolRail = new BlueWoolRail(blueWoolRailID).setBlockName("blueWoolRail");
        brownWoolRail = new BrownWoolRail(brownWoolRailID).setBlockName("brownWoolRail");
        greenWoolRail = new GreenWoolRail(greenWoolRailID).setBlockName("greenWoolRail");
        redWoolRail = new RedWoolRail(redWoolRailID).setBlockName("redWoolRail");
        blackWoolRail = new BlackWoolRail(blackWoolRailID).setBlockName("blackWoolRail");
        //Wool Monorails//
        monorailWhite = new MonorailWhite(monorailWhiteID).setBlockName("monorailWhite");
        monorailOrange = new MonorailOrange(monorailOrangeID).setBlockName("monorailOrange");
        monorailMagenta = new MonorailMagenta(monorailMagentaID).setBlockName("monorailMagenta");
        monorailLightblue = new MonorailLightblue(monorailLightblueID).setBlockName("monorailLightblue");
        monorailYellow = new MonorailYellow(monorailYellowID).setBlockName("monorailYellow");
        monorailLime = new MonorailLime(monorailLimeID).setBlockName("monorailLime");
        monorailPink = new MonorailPink(monorailPinkID).setBlockName("monorailPink");
        monorailGray = new MonorailGray(monorailGrayID).setBlockName("monorailGray");
        monorailLightgray = new MonorailLightgray(monorailLightgrayID).setBlockName("monorailLightgray");
        monorailCyan = new MonorailCyan(monorailCyanID).setBlockName("monorailCyan");
        monorailPurple = new MonorailPurple(monorailPurpleID).setBlockName("monorailPurple");
        monorailBlue = new MonorailBlue(monorailBlueID).setBlockName("monorailBlue");
        monorailBrown = new MonorailBrown(monorailBrownID).setBlockName("monorailBrown");
        monorailGreen = new MonorailGreen(monorailGreenID).setBlockName("monorailGreen");
        monorailRed = new MonorailRed(monorailRedID).setBlockName("monorailRed");
        monorailBlack = new MonorailBlack(monorailBlackID).setBlockName("monorailBlack");
        //Wool Triplerails//
        triplerailWhite = new TriplerailWhite(triplerailWhiteID).setBlockName("triplerailWhite");
        triplerailOrange = new TriplerailOrange(triplerailOrangeID).setBlockName("triplerailOrange");
        triplerailMagenta = new TriplerailMagenta(triplerailMagentaID).setBlockName("triplerailMagenta");
        triplerailLightblue = new TriplerailLightblue(triplerailLightblueID).setBlockName("triplerailLightblue");
        triplerailYellow = new TriplerailYellow(triplerailYellowID).setBlockName("triplerailYellow");
        triplerailLime = new TriplerailLime(triplerailLimeID).setBlockName("triplerailLime");
        triplerailPink = new TriplerailPink(triplerailPinkID).setBlockName("triplerailPink");
        triplerailGray = new TriplerailGray(triplerailGrayID).setBlockName("triplerailGray");
        triplerailLightgray = new TriplerailLightgray(triplerailLightgrayID).setBlockName("triplerailLightgray");
        triplerailCyan = new TriplerailCyan(triplerailCyanID).setBlockName("triplerailCyan");
        triplerailPurple = new TriplerailPurple(triplerailPurpleID).setBlockName("triplerailPurple");
        triplerailBlue = new TriplerailBlue(triplerailBlueID).setBlockName("triplerailBlue");
        triplerailBrown = new TriplerailBrown(triplerailBrownID).setBlockName("triplerailBrown");
        triplerailGreen = new TriplerailGreen(triplerailGreenID).setBlockName("triplerailGreen");
        triplerailRed = new TriplerailRed(triplerailRedID).setBlockName("triplerailRed");
        triplerailBlack = new TriplerailBlack(triplerailBlackID).setBlockName("triplerailBlack");
        //Custom Items//
